(function($) {
  ...
  $.fn.simpleCropper = function() {
    ...
    function preview() {
      ...
      //image.src = dataUrl;
      image.src = 'http://cdn.royalbits.com/img/attach/loader.gif';
      // image.width = aspXX;
      // image.height = aspYY;
      image.className = "";
      ...
      if(document.URL == 'http://www.royalbits.com/post/special'){
        ajax_url = 'http://www.royalbits.com/post/upload';
      }
      else {
        var ajax_url = 'http://www.royalbits.com/manager/upload';
      }
      // if(document.URL == 'http://localhost:8080/post/special'){
      ...
      // }
        ...
        processData: false,
          ...
          console.log(res[1]);
          if(res[1] == 'blank'){
              image.src = "http://cdn.royalbits.com/img/test/blank.jpg";
          }
          else{
            image.src = res[1];
